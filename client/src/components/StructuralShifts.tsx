              ...
              >
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2 flex-wrap">
                    <span className={`text-[10px] font-mono px-2 py-0.5 rounded border ${trendBadge.color}`}>
                      {trendBadge.label}
                    </span>
                  ...
                  <h4 className="text-sm font-heading font-semibold text-foreground leading-snug">
                    {shift.title}
                  </h4>
                </div>
                {isExpanded ? (
